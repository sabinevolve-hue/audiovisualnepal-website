...
const DSPPA: Product[] = [
  ...
  // ── DSP9100H: IP Network PA System Host ──────────────────────────────────
  {
    ...
    imageUrl: "https://www.dsppatech.com/uploads/image/20230927/10/ip-audio-system.jpg",
    ...
    gallery: [
      "https://www.dsppatech.com/uploads/image/20230927/10/ip-audio-system.jpg",
    ],
  },
  // ── MAG6182II Pro: IP Network Amplifier 180W 6-Zone ──────────────────────
  {
    ...
    gallery: [
      "https://www.dsppatech.com/uploads/image/20220722/17/mag6182ii.jpg",
    ],
  },
]
...
const INFOBIT: Product[] = [
  ...
  // ── iCam VB40: USB Video Bar 4K ──────────────────────────────────────────
  {
    ...
    imageUrl: "https://www.infobitav.com/wp-content/uploads/2024/08/iCam-VB40-B1-scaled.webp",
    imageFallback: "#6366F1",
    ...
    gallery: [
      "https://www.infobitav.com/wp-content/uploads/2024/08/iCam-VB40-B1-scaled.webp",
    ],
  },
  ...
  // ── iShare X400: 4-Screen Wireless Presentation ──────────────────────────
  {
    ...
    badge: "Featured" as const,
    imageUrl: "https://www.infobitav.com/wp-content/uploads/2024/09/iShare-X400-B-scaled.webp",
    imageFallback: "#6366F1",
    ...
    gallery: [
      "https://www.infobitav.com/wp-content/uploads/2024/09/iShare-X400-B-scaled.webp",
    ],
  },
...
const TENVEO: Product[] = [
  ...
  // ── UV612A-4K: Sony IMX415, 4K60, 12x optical, NDI|HX2 ──────────────────
  {
    ...
    imageUrl: "https://www.tenveo-video-conference.com/uploads/12429/page/full-featured-4k-12x-optical-zoom-ndi-poe-sdi2ce97.jpg",
    ...
    gallery: [
      "https://www.tenveo-video-conference.com/uploads/12429/page/full-featured-4k-12x-optical-zoom-ndi-poe-sdi2ce97.jpg",
    ],
  },
  // ── VX20M-4K: 20x AI Tracking, Sony, NDI|HX2, Tally ─────────────────────
  {
    ...
    badge: "New" as const,
    imageUrl: "https://www.tenveo-video-conference.com/uploads/12429/page/new-released-tenveo-vx20m-4k-20x-optical-zoomda04f.jpg",
    imageFallback: "#0891B2",
    ...
    gallery: [
      "https://www.tenveo-video-conference.com/uploads/12429/page/new-released-tenveo-vx20m-4k-20x-optical-zoomda04f.jpg",
    ],
  },
  // ── M5B: BT5.0 Speakerphone, 4-mic, 6M, 8000mAh ────────────────────────
  {
    ...
    imageUrl: "https://www.tenveo-video-conference.com/uploads/12429/page/bluetooth-wireless-conference-speakerphone310e3.jpg",
    imageFallback: "#0891B2",
    ...
    gallery: [
      "https://www.tenveo-video-conference.com/uploads/12429/page/bluetooth-wireless-conference-speakerphone310e3.jpg",
    ],
  },
]
