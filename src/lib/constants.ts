...
export const PRODUCT_CATEGORIES = [
  ...
  { label: 'IP Network Audio',      href: '/products/ip-network-audio',      icon: 'network',    count: 2,  description: 'TCP/IP-based distributed audio over Cat5/6 for campuses & multi-building sites' },
  ...
  { label: 'Conference Cameras',    href: '/products/conference-cameras',    icon: 'camera',     count: 7,  description: 'PTZ, 4K AI-tracking & 360° cameras for boardrooms and lecture halls' },
  { label: 'Video Conferencing',    href: '/products/video-conferencing',    icon: 'video',      count: 4,  description: 'All-in-one video bars & BYOD/BYOM systems — plug-and-play meeting rooms' },
  { label: 'Wireless Presentation', href: '/products/wireless-presentation', icon: 'wireless',   count: 1,  description: 'Cable-free screen sharing from any device — no software or dongles required' },
  ...
  { label: 'Conference Audio',      href: '/products/conference-audio',      icon: 'mic',        count: 3,  description: 'USB & Bluetooth speakerphones for crystal-clear remote meeting audio' },
  { label: 'AV Switching',          href: '/products/av-switching',          icon: 'switch',     count: 1,  description: 'HDMI matrix switchers for routing AV signals across multiple rooms' },
...
export const PRODUCT_GROUPS = [
  {
    ...
    categories: [
      ...
      { label: 'IP Network Audio', href: '/products/ip-network-audio', count: 2, desc: 'TCP/IP distributed audio' },
  ...
  },
  {
    ...
    icon: '📹',
    categories: [
      { label: 'Video Conferencing',    href: '/products/video-conferencing',    count: 4, desc: 'All-in-one video bars' },
      { label: 'Conference Cameras',    href: '/products/conference-cameras',    count: 7, desc: 'PTZ & AI-tracking cameras' },
      { label: 'Conference Audio',      href: '/products/conference-audio',      count: 3, desc: 'USB & BT speakerphones' },
      { label: 'Wireless Presentation', href: '/products/wireless-presentation', count: 1, desc: 'Cable-free screen sharing' },
      { label: 'AV Switching',          href: '/products/av-switching',          count: 1, desc: 'HDMI matrix switchers' },
    ],
  },
  {
    id: 'smart-classroom',
