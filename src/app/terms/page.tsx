    ...
    <main style={{ paddingTop: 80 }}>
      ...
      <nav aria-label="Breadcrumb" style={{ background: '#F5F5F7', padding: '12px 24px', borderBottom: '1px solid #E8E8ED' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', fontSize: 13, color: '#6E6E73', display: 'flex', gap: 8 }}>
          ...
          <span>›</span>
          <span style={{ color: '#1D1D1F', fontWeight: 500 }}>Terms of Service</span>
        </div>
      </nav>
      <section style={{ padding: '64px 24px', background: '#FFFFFF' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', fontSize: 16, lineHeight: 1.8, color: '#374151' }}>
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#1D1D1F', marginBottom: 12, marginTop: 40 }}>1. Acceptance of Terms</h2>
          <p>By accessing AudioVisual Nepal website ({SITE.url}), you agree to these Terms of Service.</p>
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#1D1D1F', marginBottom: 12, marginTop: 40 }}>2. Use of the Website</h2>
          ...
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#1D1D1F', marginBottom: 12, marginTop: 40 }}>3. Products and Services</h2>
          ...
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#1D1D1F', marginBottom: 12, marginTop: 40 }}>4. Intellectual Property</h2>
          ...
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#1D1D1F', marginBottom: 12, marginTop: 40 }}>5. Limitation of Liability</h2>
          ...
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#1D1D1F', marginBottom: 12, marginTop: 40 }}>6. Governing Law</h2>
          <p>These terms are governed by the laws of Nepal. Disputes shall be resolved in the courts of Kathmandu, Nepal.</p>
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#1D1D1F', marginBottom: 12, marginTop: 40 }}>7. Contact</h2>
          <p>Questions? Email us at <a href={`mailto:${SITE.email}`} style={{ color: '#0071E3' }}>{SITE.email}</a></p>
        </div>
      </section>
    </main>
  )
