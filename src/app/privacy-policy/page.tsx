    ...
    <main style={{ paddingTop: 80, background: '#060D1A' }}>
      ...
      <nav aria-label="Breadcrumb" style={{ background: '#0A0F1E', padding: '12px 24px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', fontSize: 13, color: '#94A3B8', display: 'flex', gap: 8 }}>
          ...
          <span>›</span>
          <span style={{ color: '#FFFFFF', fontWeight: 500 }}>Privacy Policy</span>
        </div>
      </nav>
      ...
      <section style={{ padding: '64px 24px', background: '#060D1A' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', fontSize: 16, lineHeight: 1.8, color: '#374151' }}>
          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#FFFFFF', marginBottom: 12, marginTop: 40 }}>1. Who We Are</h2>
          <p>AudioVisual Nepal is a professional audio visual solutions provider based in Kathmandu, Nepal.</p>

          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#FFFFFF', marginBottom: 12, marginTop: 40 }}>2. Information We Collect</h2>
          <p>When you use our contact form, we collect your name, email, phone, company, and project details.</p>

          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#FFFFFF', marginBottom: 12, marginTop: 40 }}>3. How We Use Your Information</h2>
          <p>We use your information to respond to inquiries, deliver services, and improve our website.</p>

          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#FFFFFF', marginBottom: 12, marginTop: 40 }}>4. Cookies</h2>
          <p>We use essential cookies only. You can disable them in your browser settings.</p>

          <h2 style={{ fontFamily: 'Manrope, sans-serif', fontSize: 22, fontWeight: 700, color: '#FFFFFF', marginBottom: 12, marginTop: 40 }}>5. Contact Us</h2>
