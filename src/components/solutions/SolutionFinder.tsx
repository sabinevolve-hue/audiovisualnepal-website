...
const SPACES: Space[] = [
  ...
  { id: "gov", label: "Government hall / chamber", href: "/solutions/government", solution: "Government conference & PA", base: [{ name: "Evolve Podium E6 smart podium", href: "/products/smart-podiums/focus-st600" }, { name: "DSPPA MAG6182II IP PA server", href: "/products/ip-network-audio/dsppa-mag6182ii" }] },
  { id: "edu", label: "School / campus", href: "/solutions/education", solution: "Education & campus PA", base: [{ name: "Evolve Podium E1 smart podium", href: "/products/smart-podiums/focus-st100" }, { name: "DSPPA MAG6182II IP PA server", href: "/products/ip-network-audio/dsppa-mag6182ii" }] },
